...
# Start of element M5
ChangePinName(M5, 2, D)
ChangePinName(M5, 3, S)
ChangePinName(M5, 1, G)

# Start of element M4
ChangePinName(M4, 2, D)
ChangePinName(M4, 3, S)
ChangePinName(M4, 1, G)

# Start of element M3
ChangePinName(M3, 2, D)
ChangePinName(M3, 3, S)
ChangePinName(M3, 1, G)

# Start of element M2
ChangePinName(M2, 2, D)
ChangePinName(M2, 3, S)
ChangePinName(M2, 1, G)
...
# Start of element D4
ChangePinName(D4, 1, A)
ChangePinName(D4, 2, C)

# Start of element D5
ChangePinName(D5, 1, A)
ChangePinName(D5, 2, C)
