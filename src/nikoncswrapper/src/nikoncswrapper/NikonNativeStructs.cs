...
namespace Nikon
{
    ...
    {
        public fixed UInt16 wcDate1[9]; // 1st date
        public fixed UInt16 wcDate2[9]; // 2nd date
        public fixed UInt16 wcDate3[9]; // 3rd date
    }
    ...
    {
        public UInt32 ulParameter1;
        public UInt32 ulParameter2;
    }
